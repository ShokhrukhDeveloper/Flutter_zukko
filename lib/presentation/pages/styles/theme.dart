...
import 'package:zukko_books/presentation/utils/fonts.dart';
...
class ZukkoTheme with ChangeNotifier {
  ...
  ZukkoTheme._(this._colorSet, this._preference, this._mode, this._iconSet,
      this._fontSet);

  static Future<ZukkoTheme> get create async {
